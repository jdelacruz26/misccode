...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(status root_indicator os_icon host dir_writable dir vcs)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(load ram_joined command_execution_time background_jobs ssh time)
...
#Modify the BSSID address for your own BSSID
zsh_wifi_signal(){
    local signal=$(nmcli device wifi list bssid BSSID | awk '$6!="SIGNAL"{print $6}')
    local color='%F{yellow}'
    [[ $signal -gt 85 ]] && color='%F{green}'
